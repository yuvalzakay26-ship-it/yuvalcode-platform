...
import { Youtube, ArrowLeft, Mail, MessagesSquare, Compass } from "lucide-react";
...
export function ProjectsFinalCTA() {
    return (
        <section
            ...
            aria-labelledby="projects-final-cta-heading"
        >
            {/* Background */}
            ...
            <div className="container px-4 mx-auto relative z-10">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <h2 id="projects-final-cta-heading" className="font-display text-4xl md:text-5xl lg:text-5xl font-black mb-6 text-white tracking-normal leading-[1.05]">
                            עקוב אחרי <span className="text-brand-gradient">הבנייה</span>.
                        </h2>
                        <p className="text-lg md:text-xl text-ink-muted mb-10 leading-relaxed max-w-2xl mx-auto">
                            כל מערכת כאן ממשיכה להתפתח. סרטון בשבוע, commit ביום, ומדי כמה חודשים — phase חדש שעולה לאוויר.
