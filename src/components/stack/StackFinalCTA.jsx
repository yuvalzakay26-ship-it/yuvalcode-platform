...
import { Youtube, ArrowLeft, Mail, MessagesSquare, Compass, Workflow } from "lucide-react";
import { Button } from "../ui/Button";
import { SITE, WHATSAPP_LINK } from "../../lib/constants";

export function StackFinalCTA() {
    return (
        <section
            className="py-24 relative overflow-hidden"
            aria-labelledby="stack-final-cta-heading"
        >
            {/* Background */}
            ...
            <div className="container px-4 mx-auto relative z-10">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <h2
                            id="stack-final-cta-heading"
                            className="font-display text-4xl md:text-5xl lg:text-5xl font-black mb-6 text-white tracking-normal leading-[1.05]"
                        >
                            הצטרף ל-<span className="text-brand-gradient">Stack</span>.
                        </h2>
                        <p className="text-lg md:text-xl text-ink-muted mb-10 leading-relaxed max-w-2xl mx-auto">
                            ה-stack ימשיך להתפתח — workflows חדשים, automations חדשות, ולקחים שעולים מבניית מערכות אמיתיות.
                            הירשם לערוץ והצטרף ליוצר שבונה מערכת הפעלה ציבורית.
                        </p>
