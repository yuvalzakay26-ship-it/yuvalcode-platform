...
import { Layers, Eye, Infinity as InfinityIcon } from "lucide-react";
...
const PILLARS = [
    {
        ...
        title: "מערכות, לא רעש.",
        body: "Stack לא נבנה מטרנדים. כל כלי קיבל מקום אחרי שהוא הוכיח שהוא חוסך זמן, מחזיק לאורך זמן, ומשתלב עם הכלים שכבר ב-stack.",
    },
    {
        icon: Eye,
        eyebrow: "Learn in public",
        title: "ללמוד בפומבי.",
        body: "כל workflow כאן תועד פעם — בסרטון, ב-PR, או ב-vault. ה-stack הוא לא רק שלי; הוא משאב חי לכל יוצר שמנסה לבנות סביבה אמיתית.",
    },
    {
        icon: InfinityIcon,
        eyebrow: "Sustainable workflows",
        title: "קצב שמחזיק שנים.",
        body: "Build-in-public לא שורד על דחיפה. הוא שורד על מערכת. ה-stack הזה תוכנן לקצב של עשור, לא לספרינט של רבעון — וזה המבנה שמייצר תוצאות אמיתיות.",
    },
];
...
export function WhyThisStack() {
    ...
    return (
        <section
            ...
            aria-labelledby="why-this-stack-heading"
        >
            <div className="container px-4 mx-auto">
                <div className="max-w-2xl mx-auto text-center mb-16">
                    ...
                    <h2
                        id="why-this-stack-heading"
                        className="font-display text-3xl md:text-5xl font-bold text-ink mb-4 tracking-normal"
                    >
                        למה ה-<span className="text-brand-gradient">Stack</span> נראה ככה.
                    </h2>
                    <p className="text-ink-muted text-base md:text-lg leading-relaxed">
                        שלוש החלטות שמכוונות את כל הבחירות. אין כאן הייפ — יש שלוש ברירות מחדל שמחזיקות לאורך זמן.
                    </p>
                </div>
